        ...
        <?php
                ...
                foreach($data as $entry){            
                    echo("<div class='container'><ul>
                        ...
                        <li class='actions'><a href='client_form.php'><img src='img/ajouter.svg' class='btn-actions' alt='Ajouter'></a>
                        <a href='editer_client.php?id=".$entry["id_client"]."'><img class='btn-actions' src='img/editer.svg' alt='Editer'></a>
                        <a href='model/supprimer.php?type=client&id=".$entry["id_client"]."'> <img class='btn-actions' src='img/supprimer.svg' alt='Supprimer'></a>
                        </li></ul></div>");
                }
            ?>
